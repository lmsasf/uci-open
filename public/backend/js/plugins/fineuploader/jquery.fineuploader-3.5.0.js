...
qq.FineUploader = function(o){
    ...
    qq.extend(this._options, {
        ...
        template: '<div class="qq-uploader">' +
            ...
            (!this._options.button ? '<a class="button greenB qq-upload-button" style="margin: 5px;" title="" href="#"><img class="icon" alt="" src="/backend/images/icons/light/upload.png"><span>{uploadButtonText}</span></a>' : '') +
        ...
        classes: {
            ...
            success: 'qq-upload-success nNote nSuccess',
            fail: 'qq-upload-fail nNote nFailure',
