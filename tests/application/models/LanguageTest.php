<?php
/**
 * Test Unitario de Language
 * @author damills
 *
 */
class LanguageTest  extends Zend_Test_PHPUnit_ControllerTestCase {
	...
	public function testGetOCWLanguagesFilter(){
		$result = $this->Table->getOCWLanguagesFilter();
		if(is_array($result)){
			$result = true;
		}
		$this->assertTrue( $result , 'Todo OK');		
